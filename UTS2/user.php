...
<body >
  ...
  <div class="text"><i class="fa-solid fa-address-book"></i> </div>
    <div class="container">
<div class="row">
    ...
    $koneksi=mysqli_connect("localhost","root","","nasabah");
		...
		<tr>
            ...
            <td><a class="btn teal modal-trigger" href="#user_edit<?php echo $r['id_user'] ?>">Edit</a> <a class="red btn" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="proses.php?action=hapus&id=<?php echo $r['id_user'] ?>">Hapus</a></td> 
